...
<Callout type="warn">
  Rate limiting is enabled automatically when both Upstash variables are set. Without them, your endpoint has no protection against abuse. See [Setup Upstash](/docs/installation/setup-upstash) for details.
</Callout>
